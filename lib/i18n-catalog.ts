const keys = [
  ...
  "register.password", "register.password_help", "register.password_confirm", "register.country", "register.gender", "register.gender_none", "register.gender_male", "register.gender_female", "register.gender_other", "register.age", "register.terms", "register.privacy", "register.already_signed_in",
